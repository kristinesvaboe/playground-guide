...
- Users can tap "Not interested" on the preview card to hide a playground from their own map only (no confirmation; other users still see it). The pin disappears immediately and stays hidden across reloads
